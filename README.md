...
- Just Configuring the RTAB Map launch to Mapping or Localization mode is enough and `move_base.launch` can be directly executed and used by setting a Goal Pose  through RVIZ. 
