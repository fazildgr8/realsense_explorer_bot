...
- Autonomous environment exploration  mobile robot which has 3-DOF manipulator with Intel Realsense D435i mounted on a Tracked skid-steer differential drive mobile  robot fully controlled with ROS in **Jetson Nano** board. 
...
- The custom built Robot uses ROS Realsense D435i RGB-D sensor with dexterity for perception and with Rviz visulaization of Robot State, Point Cloud and the generated map. The Robot uses Realtime Appearance Based Mapping (RTAB-MAP ROS package) for SLAM appliacation.
