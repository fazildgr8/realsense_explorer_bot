...
- Just Configuring the RTAB Map launch to Mapping or Localization mode is enough and move base launch can be directly executed and used by giving a Goal Pose  through RVIZ. 
